...
function clasificaCanciones(lista) {
    let listaCanciones = {};

    for (let cancion of lista) {
        if (!listaCanciones[cancion.genre]) {
            listaCanciones[cancion.genre] = [];
        }
        listaCanciones[cancion.genre].push(cancion.title);
    }
    return listaCanciones;
}

console.log(clasificaCanciones(tracks));
